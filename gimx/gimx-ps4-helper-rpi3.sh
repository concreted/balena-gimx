...
# Reference: https://raw.githubusercontent.com/matlo/GIMX-tools/master/PS4/gimx-ps4-helper.sh
# Modified to only work with onboard RPI3 Bluetooth.
...
# This has been modified to only check for the onboard bluetooth.
